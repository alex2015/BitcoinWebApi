...
using Lib.Services.Coins.Cryptocoin;
using Lib.Services.Coins.Dallar;
using Lib.Services.Coins.Dash;
using Lib.Services.Coins.Dogecoin;
using Lib.Services.Coins.Litecoin;
using Lib.Services.Coins.Mogwaicoin;
using Lib.Services.Coins.Sarcoin;
using Lib.Services.Coins.Smartcash;
